...
class CanchaDetalle extends StatefulWidget {
  /*const CanchaDetalle(int i, {Key? key, required this.canchaId})
      : super(key: key);*/
  ...
  @override
  State<CanchaDetalle> createState() => _CanchasState();
}

class _CanchasState extends State<CanchaDetalle> {
